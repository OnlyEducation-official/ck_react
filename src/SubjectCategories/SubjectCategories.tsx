...
type SubjectCategorySchemaType = z.infer<typeof SubjectCategorySchema>;
...
export default function SubjectCategories() {
  ...
  } = useForm<SubjectCategorySchemaType>({
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await api<ApiSuccessResponse<SubjectCategorySchemaType> | ApiErrorResponse>(
  ...
  const onSubmit = async (data: SubjectCategorySchemaType) => {
    try {
      const isEdit = Boolean(qid);
      const url = isEdit ? `subject-categories/${qid}` : `subject-categories`;

      const res = await api<ApiSuccessResponse<SubjectCategorySchemaType> | ApiErrorResponse>(url, {
        headers: {
